...
-- Comando "teclado" — sem args lista layouts; com arg troca
-- Como KB é módulo compartilhado, trocar aqui afeta o editor também
...
function Console:desenhar()
    ...
    -- Indicador de layout no canto direito do header
...
-- ============================================================
-- CAPTURA DE TEXTO — delega ao módulo KB
-- ============================================================
