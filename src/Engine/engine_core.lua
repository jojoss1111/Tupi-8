...
function Janela.tempo()      return tonumber(C.tupi_tempo())           end
function Janela.dt()         return tonumber(C.tupi_delta_tempo())     end
function Janela.largura()    return tonumber(C.tupi_janela_largura())  end
function Janela.altura()     return tonumber(C.tupi_janela_altura())   end
function Janela.larguraPx()  return tonumber(C.tupi_janela_largura_px()) end
...
function Input.teclaPressionou(t) return C.tupi_tecla_pressionou(t) == 1 end
function Input.teclaSoltou(t)     return C.tupi_tecla_soltou(t)     == 1 end
...
function Input.mouseX()   return tonumber(C.tupi_mouse_mundo_x())  end
function Input.mouseY()   return tonumber(C.tupi_mouse_mundo_y())  end
function Input.mouseDX()  return tonumber(C.tupi_mouse_mundo_dx()) end
...
function Input.mouseXRaw() return tonumber(C.tupi_mouse_x()) end
