...
/* Define a cor/tint atual do batch — capturada no momento do enviarBatch.
   A fonte bitmap branca multiplica pixel-a-pixel: branco vira essa cor,
   transparente fica transparente. Para sprites coloridos funciona como tint.
   Chame tupi_sprite_reset_cor() para voltar ao branco (sem tint). */
...
/* Versão raw: passa cor RGBA explicitamente (útil para quads de texto/UI) */
